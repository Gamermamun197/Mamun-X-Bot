...
const ownerNumber = ['8801786269298']
...
console.log("CONNECTING Mamun X Bot 🧬...");
...
console.log('Mamun X Bot CONNECTED TO WHATSAPP ENJOY ✅')
...
if(senderNumber.includes("8801786269298")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, Mamun X Bot STARTED ✅");
});
